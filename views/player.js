export class Player{
    constructor(width,height){
      this.check = null;
        ...
        this.imagedamge.src = 'img/damge.png'
    ...
    draw(context){
        if(this.check){
          ...
          context.closePath();
          context.clip();
          context.drawImage(this.check.image, centerX - radius, bottomY - this.imageHeight, this.imageWidth, this.imageHeight);
          context.restore();
          ...
          context.drawImage(this.imagedamge, this.height/2 -100, this.height - 200, 45, 45);
          context.drawImage(this.imagebullet, this.height/2 -100, this.height - 265, 45, 45);
          context.drawImage(this.imagehp, this.height/2 -100, this.height - 135, 45, 45);
          context.lineWidth = 4;
          ...
          context.strokeText(`🚀 : ${this.bullets} ${this.max}`, this.height/2, this.height - 235);
          context.fillText(`🚀 : ${this.bullets} ${this.max}`, this.height/2, this.height - 235);

          context.strokeText(`Dm: ${this.bulletDamge}`, this.height/2, this.height - 165);
          context.fillText(`Dm: ${this.bulletDamge}`, this.height/2, this.height - 165);

          context.strokeText(`HP: ${this.playerhealth}`,this.height/2, this.height - 105);
          context.fillText(`HP: ${this.playerhealth}`,this.height/2, this.height - 105);
